...
- [`apng`](https://en.wikipedia.org/wiki/APNG) — [image details](https://freewebptojpg.com/mime/image/apng) - Animated Portable Network Graphics
- [`ar`](<https://en.wikipedia.org/wiki/Ar_(Unix)>)
- [`arj`](https://en.wikipedia.org/wiki/ARJ)
- [`arrow`](https://arrow.apache.org) - Columnar format for tables of data
- [`arw`](https://en.wikipedia.org/wiki/Raw_image_format#ARW) — [image details](https://freewebptojpg.com/mime/image/sony-arw) - Sony Alpha Raw image file
- [`asar`](https://github.com/electron/asar) - Simple extensive tar-like archive format with indexing
- [`asf`](https://en.wikipedia.org/wiki/Advanced_Systems_Format) - Advanced Systems Format
- [`avi`](https://en.wikipedia.org/wiki/Audio_Video_Interleave)
- [`avif`](<https://en.wikipedia.org/wiki/AV1#AV1_Image_File_Format_(AVIF)>) — [image details](https://freewebptojpg.com/mime/image/avif) - AV1 Image File Format
- [`avro`](https://avro.apache.org)
- [`blend`](https://wiki.blender.org/index.php/Dev:Source/Architecture/File_Format)
- [`bmp`](https://en.wikipedia.org/wiki/BMP_file_format) — [image details](https://freewebptojpg.com/mime/image/bmp)
- [`bpg`](https://bellard.org/bpg/) — [image details](https://freewebptojpg.com/mime/image/bpg)
...
- [`cr2`](https://fileinfo.com/extension/cr2) - Canon Raw image file (v2) — [image details](https://freewebptojpg.com/mime/image/canon-cr2)
- [`cr3`](https://fileinfo.com/extension/cr3) - Canon Raw image file (v3) — [image details](https://freewebptojpg.com/mime/image/canon-cr3)
- [`crx`](https://developer.chrome.com/extensions/crx)
- [`cur`](<https://en.wikipedia.org/wiki/ICO_(file_format)>) — [image details](https://freewebptojpg.com/mime/image/cur)
- [`dat`](https://en.wikipedia.org/wiki/Windows_Registry) - Windows Registry hive
- [`dcm`](https://en.wikipedia.org/wiki/DICOM#Data_format) — [image details](https://freewebptojpg.com/mime/image/dicom-rle) - DICOM Image File
- [`deb`](<https://en.wikipedia.org/wiki/Deb_(file_format)>)
- [`dmg`](https://en.wikipedia.org/wiki/Apple_Disk_Image)
- [`dng`](https://en.wikipedia.org/wiki/Digital_Negative) — [image details](https://freewebptojpg.com/mime/image/dng) - Adobe Digital Negative image file
...
- [`flif`](https://en.wikipedia.org/wiki/Free_Lossless_Image_Format) — [image details](https://freewebptojpg.com/mime/image/flif)
- [`flv`](https://en.wikipedia.org/wiki/Flash_Video)
- [`gif`](https://en.wikipedia.org/wiki/GIF) — [image details](https://freewebptojpg.com/mime/image/gif)
- [`glb`](https://github.com/KhronosGroup/glTF) - GL Transmission Format
- [`gz`](https://en.wikipedia.org/wiki/Gzip)
- [`heic`](https://nokiatech.github.io/heif/technical.html) — [image details](https://freewebptojpg.com/mime/image/heic)
- [`icc`](https://en.wikipedia.org/wiki/ICC_profile)
- [`icns`](https://en.wikipedia.org/wiki/Apple_Icon_Image_format) — [image details](https://freewebptojpg.com/mime/image/apple-icns)
- [`ico`](<https://en.wikipedia.org/wiki/ICO_(file_format)>) — [image details](https://freewebptojpg.com/mime/image/ico)
...
- [`j2c`](https://en.wikipedia.org/wiki/JPEG_2000) — [image details](https://freewebptojpg.com/mime/image/j2c) - JPEG 2000 codestream
- [`jar`](https://en.wikipedia.org/wiki/JAR_(file_format))
- [`jp2`](https://en.wikipedia.org/wiki/JPEG_2000) — [image details](https://freewebptojpg.com/mime/image/jpeg-2000) - JPEG 2000
- [`jpg`](https://en.wikipedia.org/wiki/JPEG) — [image details](https://freewebptojpg.com/mime/image/jpeg)
- [`jls`](https://en.wikipedia.org/wiki/JPEG-LS) — [image details](https://freewebptojpg.com/mime/image/jpeg-ls)
- [`jmp`](https://www.jmp.com) - JMP data file
- [`jpm`](https://en.wikipedia.org/wiki/JPEG_2000) — [image details](https://freewebptojpg.com/mime/image/jpm) - JPEG 2000
- [`jpx`](https://en.wikipedia.org/wiki/JPEG_2000) — [image details](https://freewebptojpg.com/mime/image/jpx) - JPEG 2000
- [`jxl`](https://en.wikipedia.org/wiki/JPEG_XL) — [image details](https://freewebptojpg.com/mime/image/jxl) - JPEG XL image format
- [`jxr`](https://en.wikipedia.org/wiki/JPEG_XR) — [image details](https://freewebptojpg.com/mime/image/jxr)
- [`ktx`](https://www.khronos.org/opengles/sdk/tools/KTX/file_format_spec/) — [image details](https://freewebptojpg.com/mime/image/ktx)
...
- [`nef`](https://www.nikonusa.com/en/learn-and-explore/a/products-and-innovation/nikon-electronic-format-nef.html) — [image details](https://freewebptojpg.com/mime/image/nikon-nef) - Nikon Electronic Format image file
...
- [`orf`](https://en.wikipedia.org/wiki/ORF_format) — [image details](https://freewebptojpg.com/mime/image/olympus-orf) - Olympus Raw image file
...
- [`png`](https://en.wikipedia.org/wiki/Portable_Network_Graphics) — [image details](https://freewebptojpg.com/mime/image/png)
...
- [`psd`](https://en.wikipedia.org/wiki/Adobe_Photoshop#File_format) — [image details](https://freewebptojpg.com/mime/image/psd)
- [`pst`](https://en.wikipedia.org/wiki/Personal_Storage_Table)
- [`qcp`](https://en.wikipedia.org/wiki/QCP)
- [`raf`](https://en.wikipedia.org/wiki/Raw_image_format) — [image details](https://freewebptojpg.com/mime/image/fuji-raf) - Fujifilm RAW image file
...
- [`rw2`](https://en.wikipedia.org/wiki/Raw_image_format) — [image details](https://freewebptojpg.com/mime/image/Panasonic-raw-(rw2)) - Panasonic RAW image file
...
- [`tif`](https://en.wikipedia.org/wiki/Tagged_Image_File_Format) — [image details](https://freewebptojpg.com/mime/image/tiff)
...
- [`webp`](https://en.wikipedia.org/wiki/WebP) — [image details](https://freewebptojpg.com/mime/image/webp)
- [`woff2`](https://en.wikipedia.org/wiki/Web_Open_Font_Format)
- [`woff`](https://en.wikipedia.org/wiki/Web_Open_Font_Format)
- [`wv`](https://en.wikipedia.org/wiki/WavPack) - WavPack
- [`xcf`](<https://en.wikipedia.org/wiki/XCF_(file_format)>) — [image details](https://freewebptojpg.com/mime/image/xcf) - eXperimental Computing Facility
